    ...
    <div className="space-y-4 pt-2 px-2 pb-6">
      <header className="flex justify-between items-center bg-[#12121A] p-4 rounded-3xl border border-gray-800 shadow-sm sticky top-2 z-10">
        ...
        <div className="text-center">
           <h2 className="text-xl font-bold text-white">{isToday ? "Today" : format(currentDate, 'MMM d, yyyy')}</h2>
           <p className="text-xs text-gray-500 font-medium tracking-widest uppercase">{format(currentDate, 'EEEE')}</p>
        </div>
        <button 
